...
export class SliderListComponent implements OnInit {
  ...
  @Input() label:string;
  @Input() isInitClick:boolean = false;
  @Input() sliderClass:string;
  @Output() onLeftSlide:EventEmitter<any> = new EventEmitter();
  @Output() onRightSlide:EventEmitter<any> = new EventEmitter();
  @Output() onItemClick:EventEmitter<any> = new EventEmitter();

  public sliderPos:number = 0;
  public sliderDom:any;
  public itemDomWidth:any;
  public showLeftSlide:boolean  = false;
  public showRightSlide:boolean = false;
